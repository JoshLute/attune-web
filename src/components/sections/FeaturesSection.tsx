...
const FeaturesSection = () => {
  const basicFeatures = [{
    name: "Real-time confusion detection",
    available: true
  }, {
    name: "Basic engagement metrics",
    available: true
  }, {
    name: "Session recordings (7 days)",
    available: true
  }, {
    name: "Single student tracking",
    available: true
  }, {
  ...
  const proFeatures = [{
    ...
    name: "Advanced engagement analytics",
    available: true
  }, {
    name: "Session recordings (30 days)",
    available: true
  }, {
    name: "Multiple student tracking",
    available: true
  }, {
        ...
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4">
                {basicFeatures.map((feature, index) => <div key={index} className="flex items-center">
                    {feature.available ? <Check className="h-5 w-5 text-green-500 mr-3" /> : <X className="h-5 w-5 text-gray-300 mr-3" />}
            ...
            <div className="relative">
              ...
              <div className="relative z-10 bg-white p-6 rounded-lg shadow-lg">
                <img alt="Basic dashboard visualization" className="w-full h-auto rounded-lg" src="/lovable-uploads/5a2c6794-8c42-451a-ad43-a6425c6912a9.png" />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="md:order-2">
              ...
              <div className="space-y-4">
                {proFeatures.map((feature, index) => <div key={index} className="flex items-center">
            ...
            <div className="md:order-1 relative">
              ...
              <div className="relative z-10 bg-white p-6 rounded-lg shadow-lg">
                <img alt="Advanced dashboard visualization" className="w-full h-auto rounded-lg" src="/lovable-uploads/2091d038-a70d-4ec3-b02f-1b107fed04ee.png" />
              </div>
            </div>
          </div>
        </div>
