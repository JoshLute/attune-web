      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
          {solutions.map((solution, index) => (
            <div key={index} className="neumorphic-card p-6 rounded-xl relative overflow-hidden group transition-all duration-300">
        ...
        {/* Product Screenshots - Staggered Layout */}
        <div className="space-y-16">
          {/* Student Dashboard - Left aligned */}
          <div className="flex justify-start">
            <div className="neumorphic-card p-8 rounded-xl max-w-4xl w-full">
              <h3 className="text-3xl font-bold mb-6 text-center">Real-Time Student Monitoring</h3>
              <div className="rounded-lg overflow-hidden mb-6">
                <img 
                  alt="Student dashboard showing JP Vela's real-time cognitive tracking data" 
                  className="w-full h-auto" 
                  src="/lovable-uploads/ed9c0eaf-dfa8-4329-b890-4a406456e97c.png" 
                />
              </div>
          ...
          {/* AI Assistant - Right aligned */}
          <div className="flex justify-end">
            <div className="neumorphic-card p-8 rounded-xl max-w-4xl w-full">
              <h3 className="text-3xl font-bold mb-6 text-center">AI Teaching Assistant</h3>
              <div className="rounded-lg overflow-hidden mb-6">
                <img 
                  alt="AI assistant interface showing collaboration hub and chat functionality" 
                  className="w-full h-auto" 
                  src="/lovable-uploads/edb28901-2306-497d-aaec-c7bc60c1fea5.png" 
                />
              </div>
              <p className="text-gray-600 text-center text-lg">
