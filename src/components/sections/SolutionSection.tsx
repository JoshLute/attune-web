      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-20">
          ...
          <div className="neumorphic-card p-6 rounded-xl">
            ...
            <div className="rounded-lg overflow-hidden mb-4">
              <img alt="AI assistant interface showing collaboration hub and chat functionality" className="w-full h-auto" src="/lovable-uploads/e41b482d-b347-484c-bc39-4f31c6397e08.png" />
            </div>
            <p className="text-gray-600 text-center">
